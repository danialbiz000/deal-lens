...
p("The project's real empirical result (Part V.3) delivered a finding more "
  ...
  "unreliable data as a control, was untouched.")
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 15 then ran the India findings through "
  ...
  "second surviving finding entirely.")
p("The fix that survived all of that scrutiny is more modest, and "
  ...
  "best-supported-looking result, twelve times in a row &mdash; six "
  ...
  "oversimplification, ran an eleventh check (Part V.15) against its "
  "own <i>informal</i> version of that discovery and found the formal, "
  "multiple-testing-corrected test was more conservative than the "
  "eyeballed comparison that had motivated it, on both signals, in "
  "different directions &mdash; and finally ran a twelfth check (Part "
  "V.16) that did what none of the previous eleven had: it asked "
  "whether the underlying data could even support the question being "
  "asked of it, and found that for reversal, across every one of those "
  "eleven checks, it could not. Not finding an escape hatch, finding "
  "the same shape twice in independent places, discovering the two "
  ...
  "trusted, and then discovering that the entire multi-milestone "
  "argument about reversal had been conducted on three stocks, are "
  "all findings: the project never found a result, an explanation, or "
  "even a way of testing an explanation, durable enough to stop "
  "re-checking. What survives is smaller and more precisely qualified "
  ...
  "single largest break in the series, is this project's one "
  "remaining, twelve-times-checked finding. Short-term reversal is "
