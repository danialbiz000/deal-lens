...
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 36 then ran the India findings through "
...
p("The fix that survived all of that scrutiny is more modest, and "
  ...
  "most recent, best-supported-looking result, thirty-three times in a row "
  ...
  "finally ran a thirty-third check (Part V.37) that refused to leave "
  ...
  "the more robust-looking one all along. "
  ...
  "this project had used everywhere had never once surfaced. And Part "
  "V.37 finally asked why, rather than resting on the asymmetry as a "
  ...
  "market that looked more robust the whole time. What "
  "remains open, after thirty-three checks, is not a "
  ...
  "comparison has itself been checked, and the "
