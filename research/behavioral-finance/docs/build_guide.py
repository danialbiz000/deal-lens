...
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 35 then ran the India findings through "
...
p("The fix that survived all of that scrutiny is more modest, and "
  ...
  "most recent, best-supported-looking result, thirty-two times in a row "
  ...
  "return numbers alone would never have shown, and finally ran a "
  ...
  "fragility the flat baseline number alone had never revealed. "
  ...
  "markets apart rather than confirming them alike, are "
  "all "
  ...
  "surfaced. And Part V.36 finally turned the same scrutiny on a "
  ...
  "this project had used everywhere had never once surfaced. What "
  "remains open, after thirty-two checks, is not a "
