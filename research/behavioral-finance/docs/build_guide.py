...
box(
    ...
    "flat and strong through 2008, then broke sharply. <b>Momentum's "
    ...
    "right but misdescribed the mechanism.</b>",
...
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 13 then ran the India findings through "
  ...
  "break than the same slow crowding story.")
p("The fix that survived all of that scrutiny is more modest, and the "
  ...
  "clock: reversal's held until roughly the mid-2000s in a genuine, "
  "gradual decline, while momentum's held, essentially undiminished, "
  "all the way to the 2008-09 financial crisis before breaking sharply. "
  "Neither date is the &quot;true&quot; boundary in some deeper sense "
  "&mdash; they are this project's best current point estimates, "
  "arrived at only by measuring the decay directly instead of assuming "
  "a shared timeline for two different signals. Every one of those "
  ...
  "best-supported-looking result, eight times in a row &mdash; six "
  ...
  "against its own explanation for the ninth, and discovered that even "
  "&quot;two signals, one shared story&quot; was itself an "
  "oversimplification. Not finding an escape hatch, finding the same "
  "shape twice in independent places, and then discovering the two "
  "places didn't actually share a shape after all, are all findings: "
  "the project never found a result, or an explanation for a result, "
  "durable enough to stop re-checking. What survives is smaller and more "
  "precisely dated than any single milestone first suggested: pre-2005ish "
  "reversal and pre-2009ish momentum, each long-leg-only, each decaying "
  "on its own schedule and (in momentum's case) by its own mechanism, to "
  "currently trust, and one honest, thoroughly-stress-tested absence "
  "&mdash; the most recent decade, across signals &mdash; to size "
  "nothing against.")
