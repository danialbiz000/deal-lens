...
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 37 then ran the India findings through "
...
p("The fix that survived all of that scrutiny is more modest, and "
  ...
  "most recent, best-supported-looking result, thirty-four times in a row "
  ...
  "the more robust-looking one all along, and finally ran a "
  ...
  "better, and finally discovering that the project's own selection "
  ...
  "wrong signal and buried the right one, are "
  "all "
  ...
  "market that looked more robust the whole time. And Part V.38 "
  "finally turned this whole apparatus on itself in the one way it "
  ...
  "What "
  "remains open, after thirty-four checks, is not a "
