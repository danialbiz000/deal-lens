...
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 42 then ran the India findings through "
...
p("The fix that survived all of that scrutiny is more modest, and "
  ...
  "most recent, best-supported-looking result, thirty-nine times in a row "
  ...
  "entirely different logic, had already placed it, and finally ran "
  ...
  "enough to change which risk actually drives the number. "
  ...
  "fragile up close looked fragile from thirty thousand feet too, and "
  "finally discovering that its own two stress tests of the same "
  ...
  "the caveat it was already carrying. And Part V.43 finally crossed "
  ...
  "dramatically worse. What "
  "remains open, after thirty-nine checks, is not a "
  ...
  "questions once both exist and could be crossed, and the "
