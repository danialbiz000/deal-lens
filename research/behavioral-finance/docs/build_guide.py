...
p("The practical output (Part VI) turns that into three concrete artifacts: an "
  ...
  "needed. Milestones 3 through 41 then ran the India findings through "
...
p("The fix that survived all of that scrutiny is more modest, and "
  ...
  "most recent, best-supported-looking result, thirty-eight times in a row "
  ...
  "genuinely separate rather than one counted twice, and finally ran "
  ...
  "entirely different logic, had already placed it. "
  ...
  "two real findings really were two, and finally discovering that "
  ...
  "fragile up close looked fragile from thirty thousand feet too, are "
  "all "
  ...
  "Part V.42 finally asked the question every one of the prior "
  ...
  "the caveat it was already carrying. What "
  "remains open, after thirty-eight checks, is not a "
